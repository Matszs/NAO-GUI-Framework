...
public class NewRobotPanel extends JPanel {
	...
	public NewRobotPanel() {
		...
		treeView.setBounds(10, 10, 380, 250);
    	...
    	tabbedPane1.setBounds(10, 321, 380, 290);
    	...
    	tabbedPane1.addTab("Status", null, panel_1, null);
    	panel_1.setLayout(null);
    	
    	panel_2 = new JPanel();
    	panel_2.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
    	tabbedPane1.addTab("Logfile", null, panel_2, null);
