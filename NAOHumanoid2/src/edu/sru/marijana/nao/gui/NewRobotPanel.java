...
public class NewRobotPanel extends JPanel {
	...
	public NewRobotPanel() {
    	...
    	disconnect.addActionListener(new ActionListener() {
    		public void actionPerformed(ActionEvent e) {
    			/* Disconnect selected robot */
    			disconnect();
    			/* Create robot nodes from connect object */
    			createNodes(connect);
    		}
    	});
	...
	private void disconnect(){
		...
		/* Close connection with selected robot */
	...
	public void createNodes(SynchronizedConnectDemo connect){
		...
		/* Get all connected robots from connect object and add them in nodes tree */
