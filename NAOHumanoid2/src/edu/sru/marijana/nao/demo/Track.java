...
public class Track extends Demo {
	...
	public Track(SynchronizedConnectDemo connection, String robotName) throws Exception {
		super(connection);
		...
		// TODO: @jstefanovic change to generic option dialog
		ApplicationsOptionDialog dialog = new ApplicationsOptionDialog(connection, null);
