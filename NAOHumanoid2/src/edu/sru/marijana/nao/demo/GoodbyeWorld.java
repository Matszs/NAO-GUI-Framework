package edu.sru.marijana.nao.demo;
...
public class GoodbyeWorld extends Demo {
	/**
	 ...
	 * @throws Exception
	 */
	public GoodbyeWorld(SynchronizedConnectDemo connection, String robotName) throws Exception {
		super(connection);
		// Demo Name must be Explicitly declared.
		demoName = "GoodByeWorld";
	...
	protected void run() throws Exception {
		...
		robots.add(new GoodbyeWorldDemo(robotNames.get(0), demoName, connection));
	}

	//private class is an extension of DemoRobot
	private class GoodbyeWorldDemo extends DemoRobot {
		 ...
		 * @throws Exception
		 */
		public GoodbyeWorldDemo(String name, String appName, SynchronizedConnectDemo connect) throws Exception {
