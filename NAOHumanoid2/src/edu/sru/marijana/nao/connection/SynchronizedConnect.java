...
public class SynchronizedConnect {
	...
	public boolean stopAll() {
		...
		/* Clear robot map since we don't have any robot connected anymore */
		robotMap.clear();
		isRunning = false;
		return true;
	}
	...
	public boolean stop(String name) {
		...
		/* When robot gets disconnected, its removed from the robots map (hence robots panel as well) */
