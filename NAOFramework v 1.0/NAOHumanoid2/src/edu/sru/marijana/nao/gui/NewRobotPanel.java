...
public class NewRobotPanel extends JPanel {
	...
	public NewRobotPanel() {
		...
		robotTree.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
		...
		treeView.setBounds(10, 10, 400, 315);
		...
		setPreferredSize(new Dimension(425, 720));
		setLayout(null);
		add(treeView);
		
		JPanel panel = new JPanel();
		panel.setBounds(10, 335, 400, 35);
		panel.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
		panel.setMinimumSize(new Dimension(335, 195));
		panel.setPreferredSize(new Dimension(335, 205));
		add(panel);
    	...
    	tabbedPane.setBounds(10, 381, 400, 330);
    	add(tabbedPane);
    	...
    	tabbedPane.addTab("Logfile", null, panel_2, null);
